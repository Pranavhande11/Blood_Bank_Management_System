 ...
 * @author asus
 */
public class Acceptor_History extends javax.swing.JFrame {

    /**
     * Creates new form Purchase_History
     */
    public Acceptor_History() {
        initComponents();
         try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/blooddonation","root","");
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("select * from Acceptor");
    ...
    private void initComponents() {
        ...
        jLabel17.setText("Blood Bank Availabilty Between Donor And Acceptor");
        ...
        jLabel1.setText("Acceptor History");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Acceptor_History.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

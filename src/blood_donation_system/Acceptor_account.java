...
public class Acceptor_account extends javax.swing.JFrame {

    /**
     * Creates new form Purchaser_account
     */
    public Acceptor_account(String user) {
        try {
            initComponents();
            ...
            ResultSet rs= st.executeQuery("select * from Acceptor where user='"+user+"'");
            rs.next();
            ...
            Logger.getLogger(Acceptor_account.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel17.setText("  Blood Bank Availability Between Donor and Acceptor");
        ...
        jLabel1.setText("  Acceptor  Account");
        ...
        jLabel11.setText("Select your blood group to Acceptor blood");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Acceptor_account.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Acceptor_account("user").setVisible(true);
            }
        });
    }

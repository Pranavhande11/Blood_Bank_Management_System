 ...
 * @author asus
 */
public class Acceptor_reg extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Blood Bank Availabilty Between Donor And Acceptor");
        ...
        jLabel3.setText("Acceptor Register");
       ...
       else
       {
           ...
           else
           {
               try {
                   ...
                   ResultSet rs= st.executeQuery("select count(*) from Acceptor");
                   rs.next();
                   String date=String.valueOf(java.time.LocalDate.now());
                   int no=Integer.parseInt(rs.getString(1))+1;
                   PreparedStatement stm=con.prepareStatement("insert into Acceptor values(?,?,?,?,?,?,?)");
                   stm.setInt(1, no);
                   ...
                   Logger.getLogger(Acceptor_reg.class.getName()).log(Level.SEVERE, null, ex);
               }
           }
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Acceptor_reg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Acceptor_reg().setVisible(true);
            }
        });
    }

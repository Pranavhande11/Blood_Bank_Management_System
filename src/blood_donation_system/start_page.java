...
public class start_page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Acceptor Blood");
        ...
        jButton6.setText("Blood Acceptor History");
        ...
        jRadioButton2.setText("Acceptor");
        ...
        jLabel1.setText("Blood Bank Availability Between Acceptor And Donor");
        ...
        {   
            try {
                ...
                else
                {
                    ...
                    ResultSet rs=st.executeQuery("select * from Acceptor where user='"+user+"' AND password='"+pass+"'");  
                    if(rs.next())
                    {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        new Acceptor_History().setVisible(true);
